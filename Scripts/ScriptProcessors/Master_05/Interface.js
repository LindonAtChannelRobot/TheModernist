...
const var MasterContainer = Synth.getChildSynth("Master_05");
// demo mode timer....
...
var mapNames = ["none","GlockVoice1","GlockVoice2","GlockVoice3","GlockVoice4","KalimbaVoice1","KalimbaVoice2","KalimbaVoice3","KalimbaVoice4","MarimbaVoice1","MarimbaVoice2","MarimbaVoice3","MarimbaVoice4","VibesVoice1","VibesVoice2","VibesVoice3","VibesVoice4","XyloVoice1","XyloVoice2","XyloVoice3","XyloVoice4"];
...
inline function onVoiceSelector1Control(component, value)
{
    if (value)
    {
        //close all the other selector panels.
        SelectorPanel2.showControl(false);
        SelectorPanel3.showControl(false);
        SelectorPanel4.showControl(false);
        //open our panel
        SelectorPanel1.showControl(true);
    };
};

Content.getComponent("VoiceSelector1").setControlCallback(onVoiceSelector1Control);


inline function onVoiceSelector2Control(component, value)
{
    if (value)
    {
        //close all the other selector panels.
        SelectorPanel1.showControl(false);
        SelectorPanel3.showControl(false);
        SelectorPanel4.showControl(false);
        //open our panel
        SelectorPanel2.showControl(true);
    };
};

Content.getComponent("VoiceSelector2").setControlCallback(onVoiceSelector2Control);



inline function onVoiceSelector3Control(component, value)
{
    if (value)
    {
        ...
        SelectorPanel4.showControl(false);
        //open our panel
        SelectorPanel3.showControl(true);
    };
};

Content.getComponent("VoiceSelector3").setControlCallback(onVoiceSelector3Control);



inline function onVoiceSelector4Control(component, value)
{
    if (value)
    {
        //close all the other selector panels.
        ...
        SelectorPanel3.showControl(false);
        //open our panel
        SelectorPanel4.showControl(true);
    };
};

Content.getComponent("VoiceSelector4").setControlCallback(onVoiceSelector4Control);



inline function onSelectorDismiss1Control(component, value)
{
	//close yourself
	SelectorPanel1.showControl(false);
...
Content.getComponent("SelectorDismiss1").setControlCallback(onSelectorDismiss1Control);

inline function onSelectorDismiss2Control(component, value)
{
	//close yourself
	SelectorPanel2.showControl(false);
...
Content.getComponent("SelectorDismiss2").setControlCallback(onSelectorDismiss2Control);

inline function onSelectorDismiss3Control(component, value)
{
	//close yourself
	SelectorPanel3.showControl(false);
...
Content.getComponent("SelectorDismiss3").setControlCallback(onSelectorDismiss3Control);

inline function onSelectorDismiss4Control(component, value)
{
	//close yourself
	SelectorPanel4.showControl(false);
...
Content.getComponent("SelectorDismiss4").setControlCallback(onSelectorDismiss4Control);
