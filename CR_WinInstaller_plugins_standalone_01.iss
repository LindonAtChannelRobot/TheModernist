...
Name: "StandAlone_32"; Description: "{#AppName} 32-bit Stand Alone"; Types: full custom; Check: not Is64BitInstallMode
...
; STANDALONE
Source: "Binaries\Compiled\App\{#AppName} x86.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: StandAlone_32; Check: not Is64BitInstallMode
...
; PRESETS
Source: ".\installerAssets\{#AppName}_Factory_Presets.hpa"; DestDir: "{app}"; Flags: ignoreversion;

[Icons]
Name: "{group}\Uninstall {#AppName}"; Filename: "{app}\unins000.exe"    
Name: "{group}\{#AppName}_Manual"; Filename: "{app}\TheModernistCollection_Manual.pdf"  
Name: "{group}\{#AppName} StandAlone"; Filename: "{app}\{#AppName} x86.exe"; Check: not Is64BitInstallMode 
